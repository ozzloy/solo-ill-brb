...
* Request
  * Method: POST
  * Route path: /users/:userId/spots/:spotId/images
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * Route path: /spot/:spotId/review/:reviewId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PUT
  * Route path: /spots/:spotId/bookings/:bookingId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * Route path: /spots/:spotId/reviews/:reviewId/images/:imageId
  * Body: none
